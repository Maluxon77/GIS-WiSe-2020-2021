...
(function (A3) {
    ...
    var serverantwort = document.getElementById("loginAntwort");
    function submit(_parameter) {
        return __awaiter(this, void 0, void 0, function () {
            var formData, url, query, response, text;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        formData = new FormData(document.forms[0]);
                        url = "https://gisaufgabe2020.herokuapp.com/";
